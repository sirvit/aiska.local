...
$this->title = 'Файлы Чертежей проекта для проекта'.'" '.$proekt->p_nazvanie.' "';
...
<div class="file-cp-index">
    ...
    <p>
        <?= Html::a('Добавить файл чертежей проекта', ['createproekt','id'=>$proekt->id_proekt], ['class' => 'btn btn-success']) ?>
    </p>
